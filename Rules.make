...
MAKE_ALL_TARGETS?= linux linux-dtbs linux-fitImage

#Points to the root of the project
export PROJ_ROOT_PATH?=$(shell realpath ./)
export PROJ_BINARY_OUT?=$(PROJ_ROOT_PATH)/binaryOutput
...
LINUXKERNEL_SRC_DIR=$(shell find $(PROJ_ROOT_PATH) -maxdepth 1 -type d -name "linux-imx-*")
